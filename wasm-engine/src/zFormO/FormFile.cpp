...
void CDEFormFile::serialize(Serializer& ar)
{
    ...
    printf("[FormFile] serialize starting, calling CDEFormBase::serialize...\n");
    fflush(stdout);
#endif
    CDEFormBase::serialize(ar);
#ifdef __EMSCRIPTEN__
    printf("[FormFile] CDEFormBase::serialize done, reading fonts/colors...\n");
    fflush(stdout);
#endif
...
#ifdef __EMSCRIPTEN__
    printf("[FormFile] Fonts/colors done, reading dictionary filename...\n");
    fflush(stdout);
#endif
...
#ifdef __EMSCRIPTEN__
    printf("[FormFile] Dictionary filename done, reading levels...\n");
    fflush(stdout);
#endif
...
#ifdef __EMSCRIPTEN__
    printf("[FormFile] Levels done, reading forms...\n");
    fflush(stdout);
#endif
...
#ifdef __EMSCRIPTEN__
    printf("[FormFile] Forms done, reading dictionary name...\n");
    fflush(stdout);
#endif
