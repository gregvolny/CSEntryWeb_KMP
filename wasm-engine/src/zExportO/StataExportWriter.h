...
class StataExportWriter : public ReadStatExportWriterBase
{
public:
    StataExportWriter(std::shared_ptr<const CaseAccess> case_access, const ConnectionString& connection_string);
