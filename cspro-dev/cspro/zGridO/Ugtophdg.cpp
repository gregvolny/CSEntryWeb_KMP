/******************************************************************
    ...
    CUGTopHdg   - Ultimate Grid 97

    Copyright 1995-1997 Dundas Software Ltd.
...
void CUGTopHdg::DrawCellsIntern(CDC *dc){
    ...
    rect.bottom = rect.top = rect.left = rect.right = 0; //csc 5/26/04
...
void CUGTopHdg::Update(){
    ...
    int height = 0;
    int y;
    for(y = -1; y > (m_GI->m_numberTopHdgRows * -1); y-- ){
