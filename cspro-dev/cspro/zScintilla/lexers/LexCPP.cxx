...
class LexerCPP : public ILexer5 {
	bool caseSensitive;
    int lexerLanguage; // CSPRO_SCINTILLA_MOD
...
public:
	explicit LexerCPP(bool caseSensitive_, int lexerLanguage_) : // CSPRO_SCINTILLA_MOD
		caseSensitive(caseSensitive_),
        lexerLanguage(lexerLanguage_), // CSPRO_SCINTILLA_MOD
	...
	const char * SCI_METHOD GetName() override {
		...
		return ( lexerLanguage == SCLEX_JAVASCRIPT)  ? "javascript" : "cpp"; // CSPRO_SCINTILLA_MOD
	}
	int SCI_METHOD  GetIdentifier() override {
		// return caseSensitive ? SCLEX_CPP : SCLEX_CPPNOCASE;
        return lexerLanguage; // CSPRO_SCINTILLA_MOD
	}
	const char * SCI_METHOD PropertyGet(const char *key) override;

    // CSPRO_SCINTILLA_MOD start
    static ILexer5 *LexerFactoryCPP() { 
		return new LexerCPP(true, SCLEX_CPP);
	}
	/*static ILexer5 *LexerFactoryCPPInsensitive() {
		return new LexerCPP(false);
	}*/
	static ILexer5 *LexerFactoryJavaScript() { 
		return new LexerCPP(true, SCLEX_JAVASCRIPT);
	}
    // CSPRO_SCINTILLA_MOD ebd
...
// LexerModule lmCPPNoCase(SCLEX_CPPNOCASE, LexerCPP::LexerFactoryCPPInsensitive, "cppnocase", cppWordLists);
LexerModule lmJavaScript(SCLEX_JAVASCRIPT, LexerCPP::LexerFactoryJavaScript, "javascript", cppWordLists);
