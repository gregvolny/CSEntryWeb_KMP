...
#include "../cspro_iconv.h" // CSPRO_READSTAT_MODIFICATIONS
...
readstat_error_t sav_validate_name_unreserved(const char *name); // CSPRO_READSTAT_MODIFICATIONS added to header
