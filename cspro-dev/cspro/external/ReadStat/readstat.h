...
typedef struct readstat_writer_s {
    ...
    void* object_holding_writer;
    void (*row_count_position_recorder)(size_t count_position, size_t count_size, char count_is_unsigned, void* object_holding_writer);
    void (*dta_emit_map_position_recorder)(size_t map_position, size_t record_len, uint64_t map10, uint64_t map11,
        uint64_t map12, uint64_t map13, void* object_holding_writer);
} readstat_writer_t;
