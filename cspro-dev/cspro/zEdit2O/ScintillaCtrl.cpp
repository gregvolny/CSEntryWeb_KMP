...
#include <zScintilla/CSPro/CSPro.h> // CSPRO_SCINTILLA_MOD
...
BOOL CScintillaCtrl::Create(DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, DWORD dwExStyle, LPVOID lpParam)
{
  ...
  if (!CreateEx(dwExStyle, CSProScintilla::ClassName, nullptr, dwStyle, rect, pParentWnd, nID, lpParam)) // CSPRO_SCINTILLA_MOD
    return FALSE;
#else
