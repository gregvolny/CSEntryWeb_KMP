...
// entry
config.entry = {
    main: [require('path').resolve(__dirname, "kotlin\\csentry-web.mjs")]
};
config.output = {
    filename: (chunkData) => {
    ...
    library: "CSEntryWeb_KMP",
    libraryTarget: "umd",
    globalObject: "globalThis"
};
config.output.path = require('path').resolve(__dirname, "..\\..\\..\\kotlin-webpack\\wasmJs\\productionExecutable")
// source maps
